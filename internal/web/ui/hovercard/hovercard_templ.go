...
// templui component hovercard - version: v1.12.1 installed by templui v1.12.1

// 📚 Documentation: https://templui.io/docs/components/hover-card
...
type ContentProps struct {
	...
	Offset     int
	ShowArrow  bool
	// OpenDelay is the delay in ms before the card opens on hover.
	OpenDelay int
	// CloseDelay is the delay in ms before the card closes on hover out.
	CloseDelay int
}
...
func Content(props ...ContentProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = popover.Content(popover.ContentProps{
			...
			HoverDelay:    p.OpenDelay,
			HoverOutDelay: p.CloseDelay,
			Class: utils.TwMerge(
				"w-64 p-4",
				p.Class,
			),
